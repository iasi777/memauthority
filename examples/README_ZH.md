...
精确行为以[`../docs/contract/v1.1/`](../docs/contract/v1.1/) 下的版本化公共契约为准。
...
- HTTP / OAuth 暴露前，请阅读 [`../SECURITY_ZH.md`](../SECURITY_ZH.md) 和当前的 [Transport / Auth 契约](../docs/contract/v1.1/transport-auth.md)。
