...
Follow the current frozen [transport/auth](docs/contract/v1.2/transport-auth.md), [managed runtime](docs/contract/v1.2/managed-runtime.md), and [structured error](docs/contract/v1.2/structured-errors.md) contracts. Do not weaken loopback/authentication, clean-snapshot, fencing/CAS, state-containment, or fail-closed checks to work around deployment issues.
