...
For exact CLI and transport / authentication behavior, use the versioned public contract under [`contract/v1.3.2/`](contract/v1.3.2/).
...
Then compare them with the current [`contract/v1.3.2/managed-runtime.md`](contract/v1.3.2/managed-runtime.md) contract or the frozen contract for the installed release.
